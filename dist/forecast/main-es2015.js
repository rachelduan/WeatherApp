...
SearchFormService.ctorParameters = () => [
...
let WeeklyDialogComponent = class WeeklyDialogComponent {
...
WeeklyDialogComponent.ctorParameters = () => [
...
p){ya[h]=p},addColorSet:function(h,p){Ba[h]=p},addCultureInfo:function(h,p){Ma[h]=p},formatNumber:function(h,p,r){r=r||"en";if(Ma[r])return ba(h,p||"#,##0.##",new La(r));throw"Unknown Culture Name";},formatDate:function(h,p,r){r=r||"en";if(Ma[r])return Ca(h,p||"DD MMM YYYY",new La(r));throw"Unknown Culture Name";}}; true&&"undefined"!==typeof module.exports?module.exports=Na: true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = (function(){return Na}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)):undefined;Na.Chart=function(){function h(a,
                ...
                data: [{
                        ...
                        click: (e) => {
                            this.geoService.getWeekly(this.latitude, this.longitude, this.weeklyResult[e.dataPoint.x]['time']).subscribe(resp => {
                                console.log(resp);
                                const modalRef = this.modalService.open(_weekly_dialog_weekly_dialog_component__WEBPACK_IMPORTED_MODULE_1__["WeeklyDialogComponent"]);
...
WeeklyComponent.ctorParameters = () => [
